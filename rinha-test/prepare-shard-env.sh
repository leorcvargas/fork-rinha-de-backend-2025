...
# --- 3. Install k6 ---
echo ">>> Step 3: Setting up k6 repository and installing k6..."
# Add the k6 GPG key
curl -fsSL https://k6.io/repo/gpg.key | sudo gpg --dearmor -o /usr/share/keyrings/k6-archive-keyring.gpg

# Add the k6 repository to Apt sources
echo "deb [signed-by=/usr/share/keyrings/k6-archive-keyring.gpg] https://k6.io/repo/deb stable main" | sudo tee /etc/apt/sources.list.d/k6.list
sudo apt-get update
